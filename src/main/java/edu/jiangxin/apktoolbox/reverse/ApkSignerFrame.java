...
public class ApkSignerFrame extends JFrame {

	private static final Logger logger = LogManager.getLogger(ApkSignerFrame.class);
			...
			public void mousePressed(MouseEvent e) {
				...
				try {
					...
					sb.append("java -jar \"-Duser.language=en\" \"-Dfile.encoding=UTF8\"").append(" \"")
							...
							.append(" -keystore ").append(keystorePath)
							.append(" -pswd ").append(keystorePassword)
							.append(" -alias ").append(alias)
							.append(" -aliaspswd ").append(alisaPassword)
							.append(" ")
							.append(apkPath);
